    ...
    public partial class InvoiceWiseReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                DataTable dtInvoiceWiseReport = uMethods.ConvertTo(repo.RptInvoiceWiseReport(startDate, endDate));

                ReportViewer1.LocalReport.ReportPath = "Reports\\RDLC Files\\InvoiceWiseReport.rdlc";
                ...
                var rds = new ReportDataSource("DS_InvoiceWiseReport", dtInvoiceWiseReport);
                ...
                var fileNamewithType = "inline;filename=InvoiceWiseReport.pdf";
