    ...
    public partial class DeliveryDetails : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                DataTable dtDeliveryDetails = uMethods.ConvertTo(repo.RptDeliveryDetails(startDate, endDate));

                ReportViewer1.LocalReport.ReportPath = "Reports\\RDLC Files\\DeliveryDetails.rdlc";
                ...
                var rds = new ReportDataSource("DS_DeliveryDetails", dtDeliveryDetails);
                ...
                var fileNamewithType = "inline;filename=DeliveryDetails.pdf";
