...
{
    public partial class JobWiseStatement : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                DataTable dtJobWiseStatement = uMethods.ConvertTo(repo.RptJobWiseStatement(startDate, endDate));

                ReportViewer1.LocalReport.ReportPath = "Reports\\RDLC Files\\JobWiseStatement.rdlc";
                ...
                var rds = new ReportDataSource("DS_JobWiseStatement", dtJobWiseStatement);
                ...
                var fileNamewithType = "inline;filename=JobWiseStatement.pdf";
