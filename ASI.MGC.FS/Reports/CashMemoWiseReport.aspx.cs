...
{
    public partial class CashMemoWiseReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                DataTable dtCashMemoWiseReport = uMethods.ConvertTo(repo.RptCashMemoWiseReport(startDate, endDate));

                ReportViewer1.LocalReport.ReportPath = "Reports\\RDLC Files\\CashMemoWiseReport.rdlc";
                ...
                var rds = new ReportDataSource("DS_CashMemoWiseReport", dtCashMemoWiseReport);
                ...
                var fileNamewithType = "inline;filename=CashMemoWiseReport.pdf";
