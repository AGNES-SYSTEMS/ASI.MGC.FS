...
{
    public partial class ReversedInvoice : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                DataTable dtReversedInvoice = uMethods.ConvertTo(repo.RptReversedInvoice(startDate, endDate));

                ReportViewer1.LocalReport.ReportPath = "Reports\\RDLC Files\\ReversedInvoice.rdlc";
                ...
                var rds = new ReportDataSource("DS_ReversedInvoice", dtReversedInvoice);
                ...
                var fileNamewithType = "inline;filename=ReversedInvoice.pdf";
