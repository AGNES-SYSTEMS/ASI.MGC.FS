...
{
    public partial class MrvStatement : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                DataTable dtMrvStatement = uMethods.ConvertTo(repo.RptMrvStatement(startDate, endDate));

                ReportViewer1.LocalReport.ReportPath = "Reports\\RDLC Files\\MrvStatement.rdlc";
                ...
                var rds = new ReportDataSource("DS_MrvStatement", dtMrvStatement);
                ...
                var fileNamewithType = "inline;filename=MrvStatement.pdf";
