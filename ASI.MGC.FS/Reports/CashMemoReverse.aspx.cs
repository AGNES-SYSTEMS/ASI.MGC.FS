...
{
    public partial class CashMemoReverse : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                DataTable dtCashMemoReverse = uMethods.ConvertTo(repo.RptCashMemoReverse(startDate, endDate));

                ReportViewer1.LocalReport.ReportPath = "Reports\\RDLC Files\\CashMemoReverse.rdlc";
                ...
                var rds = new ReportDataSource("DS_CashMemoReverse", dtCashMemoReverse);
                ...
                var fileNamewithType = "inline;filename=CashMemoReverse.pdf";
