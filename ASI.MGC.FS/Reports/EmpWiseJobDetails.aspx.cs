...
{
    public partial class EmpWiseJobDetails : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                DataTable dtEmpWiseJobDetails = uMethods.ConvertTo(repo.RptEmpWiseJobDetails(startDate, endDate));

                ReportViewer1.LocalReport.ReportPath = "Reports\\RDLC Files\\EmpWiseJobDetails.rdlc";
                ...
                var rds = new ReportDataSource("DS_EmpWiseJobDetails", dtEmpWiseJobDetails);
                ...
                var fileNamewithType = "inline;filename=EmpWiseJobDetails.pdf";
