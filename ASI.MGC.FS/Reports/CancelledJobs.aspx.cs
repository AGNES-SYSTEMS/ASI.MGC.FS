...
{
    public partial class CancelledJobs : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                DataTable dtCancelledJobs = uMethods.ConvertTo(repo.RptCancelledJobs(startDate, endDate));

                ReportViewer1.LocalReport.ReportPath = "Reports\\RDLC Files\\CancelledJobs.rdlc";
                ...
                var rds = new ReportDataSource("DS_CancelledJobs", dtCancelledJobs);
                ...
                var fileNamewithType = "inline;filename=CancelledJobs.pdf";
