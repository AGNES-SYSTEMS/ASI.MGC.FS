$(document).ready(function () {
    ...
    $("#btnReportSubmit").on("click", function () {
        ...
        if (isValid) {
            ...
            if (isExportMode !== null && isExportMode !== "") {
                url = "/Reports/ReversedInvoice.aspx?startDate=" + startDate + "&endDate=" + endDate + "&isExportMode=" + isExportMode;
            } else {
                url = "/Reports/ReversedInvoice.aspx?startDate=" + startDate + "&endDate=" + endDate;
            }
            $('#iframe').prop('src', url);
        } else {
    ...
    $("#txtStartDate").change(function () {
        $("#formReversedInvoice").formValidation('revalidateField', 'startDate');
    });
    $("#txtEndDate").change(function () {
        $("#formReversedInvoice").formValidation('revalidateField', 'endDate');
    });
    $('#formReversedInvoice').on('init.field.fv', function (e, data) {
