$(document).ready(function () {
    ...
    $("#btnReportSubmit").on("click", function () {
        ...
        if (isValid) {
            ...
            if (isExportMode !== null && isExportMode !== "") {
                url = "/Reports/PurchaseRegister.aspx?startDate=" + startDate + "&endDate=" + endDate + "&isExportMode=" + isExportMode;
            } else {
                url = "/Reports/PurchaseRegister.aspx?startDate=" + startDate + "&endDate=" + endDate;
            }
            $('#iframe').prop('src', url);
        } else {
    ...
    $("#txtStartDate").change(function () {
        $("#formPurchaseRegister").formValidation('revalidateField', 'startDate');
    });
    $("#txtEndDate").change(function () {
        $("#formPurchaseRegister").formValidation('revalidateField', 'endDate');
    });
    $('#formPurchaseRegister').on('init.field.fv', function (e, data) {
