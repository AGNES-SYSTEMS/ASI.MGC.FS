...
$(document).ready(function () {
    ...
    $('#txtAccountDesc').on('change', function () {
        $('#formApStatementOutStanding').formValidation('revalidateField', 'AccountDesc');
    });
    ...
    $("#btnReportSubmit").on("click", function () {
        ...
        if (isValid) {
            ...
            if (isExportMode !== null && isExportMode !== "") {
                url = "/Reports/ARStatementOutstanding.aspx?startDate=" + startDate + "&endDate=" + endDate + "&acCode=" + acCode + "&isExportMode=" + isExportMode;
            } else {
                url = "/Reports/ARStatementOutstanding.aspx?startDate=" + startDate + "&endDate=" + endDate + "&acCode=" + acCode;
            }
            $('#iframe').prop('src', url);
        } else {
    ...
    $('#formApStatementOutStanding').on('init.field.fv', function (e, data) {
