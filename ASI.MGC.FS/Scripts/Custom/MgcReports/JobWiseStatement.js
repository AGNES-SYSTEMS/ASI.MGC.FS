$(document).ready(function () {
    ...
    $("#btnReportSubmit").on("click", function () {
        ...
        if (isValid) {
            ...
            if (isExportMode !== null && isExportMode !== "") {
                url = "/Reports/JobWiseStatement.aspx?startDate=" + startDate + "&endDate=" + endDate + "&isExportMode=" + isExportMode;
            } else {
                url = "/Reports/JobWiseStatement.aspx?startDate=" + startDate + "&endDate=" + endDate;
            }
            $('#iframe').prop('src', url);
        } else {
    ...
    $("#txtStartDate").change(function () {
        $("#formJobWiseStatement").formValidation('revalidateField', 'startDate');
    });
    $("#txtEndDate").change(function () {
        $("#formJobWiseStatement").formValidation('revalidateField', 'endDate');
    });
    $('#formJobWiseStatement').on('init.field.fv', function (e, data) {
