$(document).ready(function () {
    ...
    $("#btnReportSubmit").on("click", function () {
        ...
        if (isValid) {
            ...
            if (isExportMode !== null && isExportMode !== "") {
                url = "/Reports/StockLedger.aspx?startDate=" + startDate + "&endDate=" + endDate + "&isExportMode=" + isExportMode;
            } else {
                url = "/Reports/StockLedger.aspx?startDate=" + startDate + "&endDate=" + endDate;
            }
            $('#iframe').prop('src', url);
        } else {
    ...
    $('#formStockLedger').on('init.field.fv', function (e, data) {
