$(document).ready(function () {
    ...
    $("#txtStartDate").change(function () {
        $("#formDeliveryDetails").formValidation('revalidateField', 'startDate');
    });
    $("#txtEndDate").change(function () {
        $("#formDeliveryDetails").formValidation('revalidateField', 'endDate');
    });
    $('#formDeliveryDetails').on('init.field.fv', function (e, data) {
