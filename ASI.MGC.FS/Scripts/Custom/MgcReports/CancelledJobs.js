$(document).ready(function () {
    ...
    $("#btnReportSubmit").on("click", function () {
        ...
        if (isValid) {
            ...
            if (isExportMode !== null && isExportMode !== "") {
                url = "/Reports/CancelledJobs.aspx?startDate=" + startDate + "&endDate=" + endDate + "&isExportMode=" + isExportMode;
            } else {
                url = "/Reports/CancelledJobs.aspx?startDate=" + startDate + "&endDate=" + endDate;
            }
            $('#iframe').prop('src', url);
        } else {
    ...
    $("#txtStartDate").change(function () {
        $("#formCancelledJobs").formValidation('revalidateField', 'startDate');
    });
    $("#txtEndDate").change(function () {
        $("#formCancelledJobs").formValidation('revalidateField', 'endDate');
    });
    $('#formCancelledJobs').on('init.field.fv', function (e, data) {
