$(document).ready(function () {
    ...
    $("#btnReportSubmit").on("click", function () {
        ...
        if (isValid) {
            ...
            if (isExportMode !== null && isExportMode !== "") {
                url = "/Reports/PendingMrvDetails.aspx?startDate=" + startDate + "&endDate=" + endDate + "&isExportMode=" + isExportMode;
            } else {
                url = "/Reports/PendingMrvDetails.aspx?startDate=" + startDate + "&endDate=" + endDate;
            }
            $('#iframe').prop('src', url);
        } else {
    ...
    $("#txtStartDate").change(function () {
        $("#formPendingMrvDetails").formValidation('revalidateField', 'startDate');
    });
    $("#txtEndDate").change(function () {
        $("#formPendingMrvDetails").formValidation('revalidateField', 'endDate');
    });
    $('#formPendingMrvDetails').on('init.field.fv', function (e, data) {
